...
const pending = { version: VERSION, updatedAt: UPDATED, items: [
  ...
  { id: 'pd12', sujet: 'HV6534 du 21/09 : itinéraire et fiche transport disent décollage 09:55 (nouvelle heure) ; Flightradar24 affiche un horaire programmé de 10:55 GMT (arrivée Eindhoven 15:35 inchangée) — faire confirmer l’heure du billet par Uyuni ; la prise en charge 06:20 reste valable dans les deux cas', responsable: 'Mehdi → Uyuni', echeance: '2026-09-18', level: 'alerte' },
  ] };
