...
const waves = [
  ...
  prog('p0920-1100', '2026-09-20', '11:00', 'Convoi 5 × 4×4 avec chauffeurs : Agafay → Tahannaout / Asni → Imlil – Sidi Fares → La Kasbah By Beldi (~17:30)', 'Max 4 pax par véhicule (4/4/4/4/3), SANS bagages, + 1 véhicule MRCO. Circuit différent du J3. Répartition nominative ⚠️ à établir. Heure : nouvelle heure (GMT).', '19', '5 × 4×4 (CAR 1-5) + véhicule MRCO', 'critique', ALL, 'Yes We Camp Agafay', 'La Kasbah By Beldi'),
