...
const VERSION = 'V1.13 — 18/09/2026';
const UPDATED = '2026-09-18T19:20:00+01:00';
...
const seqs = [
  ...
  S('s0919-camp', '2026-09-19', '17:00', '17:30', 'Arrivée Yes We Camp Agafay — check-in 12 tentes Top VIP', 'Yes We Camp Agafay', '19', 'orga', 'critique', 'Thé de bienvenue. Bagages déjà livrés (transporteur 2Ciels). Attribution des tentes ⚠️ non communiquée (même logique que les chambres : 12). Piscine et coucher de soleil 17:30–19:30. Rappeler la SOIRÉE BLANCHE de 20:00 : tenue blanche.', ['Bagages présents (19)', 'Tentes attribuées', 'Setup dîner : menus 6 + chevalets 6'], ALL),
  S('s0919-desert', '2026-09-19', '20:00', '00:30', 'SOIRÉE BLANCHE — dîner du désert + soirée (tamtam, cracheur de feu, DJ)', 'Yes We Camp Agafay — piscine privatisée', '19', 'restauration', 'important', 'SOIRÉE BLANCHE : les convives sont habillés en blanc (Mehdi, 18/09). Enceinte JBL MRCO sur place (apportée du 2Ciels après le briefing). Menu 6, 4 plats. Open bar 3 h inclus (vin, bière, whisky, gin, vodka, softs ; cocktails et spiritueux deluxe en supplément réglé par le groupe). ' + ALLERGIE, ['Chef briefé : 18 couverts + régimes', 'Tenue blanche rappelée au groupe à l’arrivée au camp (17:00)', 'Fin de l’open bar annoncée (3 h)'], ALL),
...
const lieux = { version: VERSION, updatedAt: UPDATED, diners: [], items: [
  ...
  { id: 'agafay', nom: 'Yes We Camp Agafay', adresse: 'Désert d\'Agafay — accès ⚠️ à confirmer', acces: 'Arrivée du convoi 4×4 vers 17:00.', quoi: ['Nuit du 19 au 20/09 : 12 tentes Top VIP (climatisation, salle de bain privée, staff 24/7) — attribution ⚠️', '19/09 20:00 SOIRÉE BLANCHE (convives en blanc) : dîner 4 plats + soirée (tamtam, cracheur de feu, DJ), open bar 3 h — menu 6, chevalets 6', '20/09 08:30 petit-déjeuner, 10:00 dromadaires, 10:30 véhicule bagages, 11:00 convoi'], jours: ['2026-09-19', '2026-09-20'], aConfirmer: true },
