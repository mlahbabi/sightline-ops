...
const people = P.map(([nom, prenom, genre, passeport, naissance, regime, ch2, t2, chK, tK, jeep]) => {
  ...
  return {
    ...
    note_hotel: `2Ciels ch. ${ch2} (${t2}, lits séparés) · Agafay tente ${ch2} (même numéro que la chambre 2Ciels) · Kasbah ch. ${chK} (${tK})`,
    note_app: notes.join(' '),
